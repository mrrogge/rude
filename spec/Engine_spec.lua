...
describe('an Engine instance:', function()
    ...
    it('exposes log module', function()
        assert.is.equal(e.log, require('rude.log'))
    end)
    ...
    describe('getScene()', function()
        ...
        it('when no scene exists return nil and an exception', function()
            local ok, err = e:getScene('test')
            assert.is.Nil(ok)
            assert.is.truthy(err:instanceOf(Exception))
        end)
    end)
    ...
    describe('newScene()', function()
        ...
        it('initializes the new scene with the engine reference', function()
            ...
            assert.spy(Scene.initialize).was.called_with(match._, match.is_ref(e))
        ...
        it('initializes the new scene with the config table', function()
            ...
            local config = {}
            e:newScene('test', Scene, {})
            assert.spy(Scene.initialize).was.called_with(match._, match._, match.is_ref(config))
        end)
