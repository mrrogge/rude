return function(engine)
    ...
    --register love.graphics.newImage as an asset loader
    engine:registerAssetLoader('image', love.graphics.newImage)

    --register an asset loader for fonts
    engine:registerAssetLoader('font', function(id)
        local args = {}
    ...
    engine.love.attach = function()
        if _attached then return engine end
    ...
    engine.love.detach = function()
        c('rt')
        if not engine.love._attached then return engine end
